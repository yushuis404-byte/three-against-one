...
const RESOURCE_KEYS := ["wood", "stone", "food", "iron", "magic_dust", "gold", "ancient_wood", "gold_ore", "mithril", "steel", "dragon_blood", "dragon_crystal", "fire_dragon_blood", "frost_dragon_blood", "toxic_dragon_blood"]
