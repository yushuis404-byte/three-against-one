...
static func get_definitions() -> Array:
	return [
		...
		_def("military.recruit_camp.first", "\u7b2c\u4e00\u5ea7\u5175\u8425", "military", ["foundation.farm.first"], _cond("building", {"tag": "recruit_camp"}), _reward(1, {"food": 5})),
		_def("military.recruit_camp.two", "\u53cc\u5175\u8425", "military", ["military.recruit_camp.first"], _cond("building_count", {"tag": "recruit_camp", "count": 2}), _reward(1, {"wood": 8})),
		_def("military.recruit_camp.worker", "\u5175\u8425\u5165\u9a7b", "military", ["military.recruit_camp.first", "foundation.worker.garrison"], _cond("building_garrison", {"tag": "recruit_camp", "worker": true}), _reward(1, {})),
		_def("military.recruit.first", "\u7b2c\u4e00\u540d\u6218\u6597\u5355\u4f4d", "military", ["military.recruit_camp.first"], _cond("unit_recruited", {"combat": true}), _reward(1, {"food": 5})),
...
static func _position_for_id(id: String) -> Vector2i:
	var positions: Dictionary = {
		...
		"military.recruit_camp.first": Vector2i(0, 0),
		"military.recruit_camp.two": Vector2i(1, 0),
		"military.recruit_camp.worker": Vector2i(1, 1),
...
static func _unlocks_for_id(id: String) -> Array:
	var hints: Dictionary = {
		...
		"military.recruit_camp.first": ["tech.common.recruitment_rules"],
